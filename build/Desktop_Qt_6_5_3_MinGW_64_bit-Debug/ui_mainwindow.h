...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        quickWidget_MapView = new QQuickWidget(layout_Main);
        quickWidget_MapView->setObjectName("quickWidget_MapView");
        quickWidget_MapView->setGeometry(QRect(0, 0, 801, 601));
        quickWidget_MapView->setResizeMode(QQuickWidget::SizeRootObjectToView);
